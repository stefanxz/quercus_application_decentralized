...
Module module_init() {
	...
	module.state.at[RFID] = Q_NULL;
	module.state.at[LASER_LEFT] = Q_NULL;
	module.state.at[LASER_RIGHT] = Q_NULL;
	...
	module.to_storage = module.dir_lookup[module.nearest[STORAGE]];
